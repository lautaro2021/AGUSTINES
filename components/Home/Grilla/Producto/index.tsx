  ...
  return (
    <div className='main'>
      <div className = 'img-cont'>
        <IoIosArrowBack onClick = {handleResta} style = {{position: 'absolute', top: '50%', left: '2%', cursor: 'pointer', zIndex: '500'}}/>
        {
          foto?.data?.map((obj:any, i:number) => {
            return (
              <img
                src = {`${process.env.REACT_APP_API || 'http://localhost:1337'}${obj?.attributes?.url}`}
        ...
        <IoIosArrowForward onClick = {handleSuma} style = {{position: 'absolute', top: '50%', right: '2%', cursor: 'pointer', zIndex: '500'}}/>
